...
The integration tests currently cover `const` and `constexpr` replacements, scope-qualified usages, function-like macros, and refusal cases such as definition sites and unsupported variadic macros.
