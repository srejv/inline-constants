...
The integration tests currently cover `const` and `constexpr` replacements, scope-qualified and template-qualified usages, object-like and function-like macros, and refusal cases such as definition sites and unsupported variadic, stringizing, or token-pasting macros.
